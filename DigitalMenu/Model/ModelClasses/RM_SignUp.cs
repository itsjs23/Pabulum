        ...
        public List<RPR_AddNewItem> AddNewItem(RP_AddNewItem rpAddNewItem)
        {
            ...
            try
            {
               ...
               // string absolutePath = @"C:\inetpub\PabulumLatest\img\items\";
                absolutePath += catName + "\\" + iteName + ".txt";
            ...
            try
            {
               ...
               // string absolutePath = @"C:\inetpub\PabulumLatest\img\items\";
                ...
                if (!File.Exists(absolutePath))
                {
                    if (rpEditItem.Image != "")
                    {
                        File.WriteAllText(absolutePath, rpEditItem.Image); // write image in new File 
                    }
                }
                else
                {
    ...
    public class RM_DeleteItem
    {
        ...
        public List<RPR_DeleteItem> DeleteItem(RP_DeleteItem rpDeleteItem)
        {
            ...
            try
            {
                ...
                string catFolder = @"F:\www\Pabulum\img\items\";
    ...
    public class RM_AddHappyHours
    {
        ...
        public List<RPR_AddHappyHours> AddHappyHours(Rp_AddHappyHours rpAddHappyHours)
        {
            ...
            try
            {
                ...
                string absolute_Path = @"F:\www\Pabulum\img\category\";
                absolute_Path += category_Name + ".txt";
                ...
                else
                {
                   ...
                   // if (rpAddHappyHours.Image != "")
                    ...
                    string OldabsolutePath = @"F:\www\Pabulum\img\category\";
                    OldabsolutePath += OldcategoryName + ".txt";
    ...
    public class RM_AddCategory
    {
        ...
        public List<RPR_AddCategory> AddCategory(RP_AddCategory rpAddCategory)
        {
            ...
            try
            {
                ...
                //string absolutePath = @"C:\www\Pabulum\Pabulum_Latest\img\category\";
                absolutePath += categoryName + ".txt";


                // create  category txt file  and category folder
                if (!File.Exists(absolutePath))
                {
                    // create and write to file 
                    File.WriteAllText(absolutePath, rpAddCategory.CategoryImage);

                    // cretae folder name as category name inside  item folder
                     string absolutePathItem = @"F:\www\Pabulum\img\items\";
                    //string absolutePathItem = @"C:\inetpub\PabulumLatest\img\items\";
    ...
    public class RM_DeleteCategory
    {
        ...
        public List<RPR_DeleteCategory> DeleteCategory(RP_DeleteCategory rpDeleteCategory)
        {
            ...
            try
            {
                ...
                //string catPath = @"C:\inetpub\PabulumLatest\img\category\";
                string catPath = @"F:\www\Pabulum\img\category\";
                catPath += catName + ".txt";
                if (File.Exists(catPath))
                {
                    ...
                    catFolder += catName;
                    new System.IO.DirectoryInfo(catFolder).Delete(true);
                }
    ...
    public class RM_UpdateCategory
    {
        ...
        public List<RPR_UpdateCategory> UpdateCategory(RP_UpdateCategory rpUpdateCategory)
        {
            ...
            try
            {
                ...
                string catPath = @"F:\www\Pabulum\img\category\";
                //string catPath = @"C:\inetpub\PabulumLatest\img\category\";
                string catOldName = catPath + oldCatName + ".txt";
                string catNewName = catPath + newcatName + ".txt";

                // item path
                string itemPath = @"F:\www\Pabulum\img\items\";
                //string itemPath = @"C:\inetpub\PabulumLatest\img\items\";
                string itemOldPath = itemPath + oldCatName;
                string itemnewPath = itemPath + newcatName;
                ...
                if (oldCatName != newcatName)
                {
                    ...
                    // update image
                    if (rpUpdateCategory.CategoryImage.Trim() != "")
                    {
                        if (File.Exists(catNewName))
                        {
                            // create file and write text 
                            File.WriteAllText(catNewName, rpUpdateCategory.CategoryImage);
                        }
                    }
    ...
    public class RM_Restaurants
    {
        ...
        public List<RPR_Restaurants> AddRestaurant(RP_Restaurants rpRestaurants)
        {
            ...
            try
            {
                ...
                string RestImagePath = @"F:\www\Pabulum\img\RestImage\";
                RestImagePath += RestName + ".txt";

                //  CHK  IMAGE EXIST OR NOT 
                if (File.Exists(RestImagePath))
                {
                    // CHK IMAGE UPDATED OR NOT 
                    if (rpRestaurants.RestImage != "")
                    {
                        // Update IaMge 
                        File.WriteAllText(RestImagePath, rpRestaurants.RestImage);
                    }
                }
                else
                {
                    ...
                    string OldRestPath = @"F:\www\Pabulum\img\RestImage\";
                    OldRestPath += OldRestName + ".txt";
                ...
                ///==== HAPPY HOUR IMAGE SECTION END -======///C:\Users\dhs\Documents\desktop\DU\Pabulum\DigitalMenu\img\
            ...
            try
            {
                ...
                if (ds != null && ds.Tables.Count > 0)
                {
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        {
                            string absolutePath = @"F:\www\Pabulum\img\RestImage\";
                            absolutePath += RestName + ".txt";
                            string RestImage = "";
                            if (File.Exists(absolutePath))
                            {
